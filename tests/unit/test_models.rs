...
fn test_monitored_process_serialization() {
    let process = MonitoredProcess {
        ...
        entitlements: vec!["entitlement".to_string()],
...
fn test_process_snapshot_new_processes_empty_previous() {
    ...
    current_processes.insert(100, MonitoredProcess {
        pid: 100,
        name: "new".to_string(),
...
fn test_process_snapshot_new_processes_same_snapshot() {
    ...
    processes.insert(100, MonitoredProcess {
        pid: 100,
...
fn test_process_snapshot_detects_multiple_new_processes() {
    ...
    old_processes.insert(100, MonitoredProcess {
        pid: 100,
        name: "old".to_string(),
    ...
    new_processes.insert(100, MonitoredProcess {
        pid: 100,
        name: "old".to_string(),
        executable_path: PathBuf::from("/old"),
        entitlements: vec![],
    ...
    new_processes.insert(101, MonitoredProcess {
        pid: 101,
        name: "new1".to_string(),
    ...
    new_processes.insert(102, MonitoredProcess {
        pid: 102,
        name: "new2".to_string(),
...
fn test_process_snapshot_terminated_process_not_detected() {
    ...
    old_processes.insert(101, MonitoredProcess {
        pid: 101,
